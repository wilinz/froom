...
class DatabaseProcessorError {
  ...
  DatabaseProcessorError(final ClassElement2 classElement) : _classElement = classElement;
  ...
  InvalidGenerationSourceError get versionIsMissing {
    return InvalidGenerationSourceError(
      ...
      todo: 'Add version to annotation. e.g. @Database(version: 1, entities: [Person, Dog])',
  ...
  InvalidGenerationSourceError get versionIsBelowOne {
    return InvalidGenerationSourceError(
      ...
      todo: 'Adjust the version of the annotation. e.g. @Database(version: 1, entities: [Person, Dog])',
      element: _classElement,
    );
  }
  ...
  InvalidGenerationSourceError get noEntitiesDefined {
    return InvalidGenerationSourceError(
      ...
      todo: 'Add entities the annotation. e.g. @Database(version:1, entities: [Person, Dog])',
      element: _classElement,
    );
  }
}
