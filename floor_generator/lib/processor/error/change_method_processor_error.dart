...
import 'package:floor_annotation/floor_annotation.dart' as annotations show OnConflictStrategy;
...
class ChangeMethodProcessorError {
  ...
  InvalidGenerationSourceError get doesNotReturnVoidNorInt => InvalidGenerationSourceError(
  ...
  InvalidGenerationSourceError get doesNotReturnVoidNorIntNorListInt => InvalidGenerationSourceError(
        '$_methodType methods have to return a Future of either void, int or List<int>.',
        element: _methodElement,
      );

  InvalidGenerationSourceError get wrongOnConflictValue => InvalidGenerationSourceError(
